...
class Experiment:
    ...
    def get_batch(self, er_vocab, er_vocab_pairs, idx, miss_ent_domain):
        ...
        # r_idx = batch[:, 0]
        # e_idx = batch[:, [i for i in range(1, batch.shape[1])]]
...
def save_checkpoint(state, filename='checkpoint/FB-AUTO/checkpoint.tar'):
    torch.save(state, filename)
    shutil.copyfile(filename, 'checkpoint/FB-AUTO/model_best.tar')
